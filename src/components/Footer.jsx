...
<footer className="bg-gray-900 py-12 px-16 font-[sans-serif]">
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
    <div>
      ...
      <ul className="space-y-3">
        <li>
          <a href="javascript:void(0)" className="text-gray-400 hover:text-white text-base transition-all">Home</a>
        </li>
        <li>
          <a href="javascript:void(0)" className="text-gray-400 hover:text-white text-base transition-all">Products</a>
        </li>
        <li>
          <a href="javascript:void(0)" className="text-gray-400 hover:text-white text-base transition-all">Contact</a>
        </li>
      </ul>
    </div>
    <div>
      ...
      <ul className="space-y-3">
        <li>
          <a href="javascript:void(0)" className="text-gray-400 hover:text-white text-base transition-all">Github</a>
        </li>
        <li>
          <a href="javascript:void(0)" className="text-gray-400 hover:text-white text-base transition-all">linkedin</a>
        </li>
        <li>
          <a href="javascript:void(0)" className="text-gray-400 hover:text-white text-base transition-all">Twitter</a>
        </li>
      </ul>
    </div>
    <div>
      ...
      <ul className="space-y-3">
        <li>
          <a href="javascript:void(0)" className="text-gray-400 hover:text-white text-base transition-all">About</a>
        </li>
        <li>
          <a href="javascript:void(0)" className="text-gray-400 hover:text-white text-base transition-all">Privacy Policy</a>
        </li>
        <li>
  ...
  <div className="sm:flex sm:items-center sm:justify-between sm:flex-row">
    <p className="text-gray-400 text-sm sm:order-1">© 2024<a href="https://readymadeui.com/" target="_blank" className="hover:underline mx-1">RJ.DECOR</a>All Rights Reserved.
    </p>
