    ...
    <>
      <footer className="bg-gray-900 py-12 px-16 font-[sans-serif]">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="flex items-center lg:justify-center flex-col">
           <div>
           <img
...
<div>                      <p className="text-white text-2xl font-semibold">RJ Decor</p>
</div>
          </div>
        </div>
          ...
          <div className="flex space-x-5 max-sm:mt-4">
            ...
            <div>
              <a href="https://www.instagram.com">
                <IoLogoInstagram className="text-white w-5 h-5 fill-gray-400 hover:fill-white" />
              </a>
            </div>
            ...
            <div>
              <a href="https://twitter.com">
                <FaTwitterSquare className="text-white w-5 h-5 fill-gray-400 hover:fill-white" />
              </a>
            </div>
