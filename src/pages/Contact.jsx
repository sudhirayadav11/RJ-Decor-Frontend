...
<section className="relative z-10  px-4 overflow-x-hidden bg-gray-50 dark:bg-dark py-20 lg:py-[60px]">
    ...
    <div className="flex flex-wrap -mx-4 lg:justify-between">
      <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
        <div className="mb-12 max-w-[570px] lg:mb-0">
          ...
          We welcome your inquiries and feedback. Whether you have a question about our products, need assistance with an order, or simply want to share your thoughts with us, we're here to help. 
